...
if ( empty($hero_title) ) {
    $hero_title = $is_en ? 'Safeguarding Commercial Assets & Structuring Corporate Growth' : 'حماية أصولك التجارية وتأمين مصالحك الاستثمارية في دبي';
}

$hero_desc = function_exists('get_field') ? get_field('hero_description') : '';
if ( empty($hero_desc) ) {
    $hero_desc = $is_en 
        ? 'We deliver premium, high-value corporate advisory, dispute resolution, and litigation defense representing clients with distinction across UAE and DIFC jurisdictions.'
        : 'نقدم نخبة الاستشارات والتمثيل القضائي وحل النزاعات للشركات والأفراد، ونحمي استثماراتكم أمام جميع المحاكم الإماراتية ومحاكم مركز دبي المالي.';
}
            ...
            <div class="hero-content reveal reveal-fade-up text-center">
                ...
                <div class="regulatory-trust-bar mt-12">
                    ...
                    <div class="trust-logos">
                        <div class="trust-logo-item" title="Dubai Courts">
                            <span>DUBAI COURTS | محاكم دبي</span>
                        </div>
                        <div class="trust-logo-item" title="DIFC Courts">
                            <span>DIFC COURTS | محاكم مركز دبي المالي</span>
                        </div>
                        <div class="trust-logo-item" title="DIAC">
                            <span>DIAC | مركز دبي للتحكيم</span>
                        </div>
                        <div class="trust-logo-item" title="RERA">
                            <span>RERA | التنظيم العقاري</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                if ( $services_query->have_posts() ) :
                    ...
                    $mock_services = array(
                        array(
                            ...
                            'desc'  => $is_en ? 'Comprehensive setup, structural advice, commercial contracts drafting, mergers and acquisitions in Dubai and offshore.' : 'استشارات تأسيس الشركات، صياغة العقود التجارية، صفقات الاستحواذ والاندماج، وحوكمة الشركات التجارية داخل الإمارات وخارجها.',
                        ...
                        array(
                            ...
                            'desc'  => $is_en ? 'Bespoke counsel in property development, landlord-tenant disputes, RERA representation, and legal titles auditing.' : 'مرافعة وحل نزاعات التطوير العقاري والمقاولات، النزاعات الإيجارية واللجان العقارية، وتمثيل الملاك والمطورين أمام مؤسسة التنظيم العقاري (RERA).',
                        ...
                        array(
                            ...
                            'desc'  => $is_en ? 'Defense counsel across Dubai Courts, DIFC Courts, and arbitration forums handling complex contract disputes.' : 'الدفاع والترافع أمام محاكم دبي، محاكم مركز دبي المالي العالمي (DIFC)، وهيئات التحكيم في القضايا المالية والمطالبات المعقدة.',
    ...
    <section id="about" class="about-section py-20 bg-light-grey">
        <div class="container about-grid">
            <div class="about-narrative reveal reveal-fade-right">
                ...
                <h2 class="text-3xl font-bold mb-6 text-forest"><?php echo $is_en ? 'A Decade of Safeguarding Commercial Interests in the UAE' : 'عقد من حماية المصالح التجارية في دولة الإمارات'; ?></h2>
                <p class="text-dark-grey leading-relaxed mb-6">
                    <?php
                    echo $is_en
                        ? 'For over a decade, Dr Ali Law Firm has set a benchmark for legal advisory services in Dubai. We advise domestic, international corporate structures and high-profile individuals with an unwavering focus on precision and commercial viability.'
                        : 'لأكثر من عقد من الزمان، صاغ مكتب الدكتور علي معياراً متميزاً للمحاماة والاستشارات القانونية في دبي. نحن نعمل مع الشركات المحلية والعالمية والأفراد ذوي الملاءة المالية، مع التركيز الكامل على دقة التحليل والجدوى التجارية.';
                    ?>
                </p>
                <p class="text-dark-grey leading-relaxed mb-6">
                    <?php
                    echo $is_en
                        ? 'Our attorneys combine technical excellence with practical business acumen. This holistic perspective ensures our clients are equipped to navigate regulatory landscapes inside the UAE confidently.'
                        : 'يجمع فريق المحامين لدينا بين التميز التقني والفطنة التجارية العملية. هذا المنظور المتكامل يضمن لعملائنا القدرة الكاملة على التنقل والنمو ضمن البيئات التشريعية والتنظيمية في دولة الإمارات بثقة تامة.';
                    ?>
                </p>
                ...
                <div class="about-features-list">
                    ...
                    <div class="feature-item">
                        <span class="feature-check">✓</span>
                        <span><?php echo $is_en ? 'DIFC & Local Courts Rights' : 'حق الترافع أمام محاكم DIFC والمحاكم المحلية'; ?></span>
                    </div>
                    <div class="feature-item">
                        <span class="feature-check">✓</span>
            ...
            <div class="why-grid">
                <div class="why-card reveal reveal-fade-up">
                    ...
                    <p class="why-desc text-dark-grey">
                        <?php echo $is_en 
                            ? 'Our profound integration with local UAE courts and regulatory departments permits streamlined procedural resolutions.' 
                ...
                if ( $judgments_query->have_posts() ) :
                    ...
                    $mock_judgments = array(
                        ...
                        array(
                            ...
                            'year'  => '2026',
                            'desc'  => $is_en 
                                ? 'Represented a prominent institutional investor in DIAC arbitration, recovering 45M AED in escrow funds.'
                                : 'تمثيل مستثمر مؤسسي بارز أمام مركز دبي للتحكيم الدولي، واسترداد 45 مليون درهم من حساب ضمان محجوز.',
                            'result'=> $is_en ? 'Recovered 45,000,000 AED' : 'استرداد 45,000,000 درهم إماراتي'
                        ),
                        array(
                            'title' => $is_en ? 'Victory in DIFC Court Commercial Agreement Breach' : 'حكم تجاري لصالح موكلنا بمحاكم DIFC لخرق شروط تعاقدية',
                            'area'  => $is_en ? 'DIFC Courts' : 'محاكم مركز دبي المالي',
                            'year'  => '2026',
                            'desc'  => $is_en 
                                ? 'Secured key judicial damages enforcement under DIFC common law for breach of distribution covenants.'
                                : 'حكم قضائي بالتعويض لخرق بنود حصرية التوزيع والتسويق التجاري وفقاً لقوانين محاكم مركز دبي المالي العالمي.',
            ...
            <div class="slider-container reveal reveal-fade-up">
                <div class="slider-track">
                    ...
                    if ( $testimonials_query->have_posts() ) :
                        ...
                        $mock_reviews = array(
                            array(
                                'name' => $is_en ? 'Tariq Al-Mansoor' : 'طارق المنصوري',
                                'role' => $is_en ? 'CEO, Al-Mansoor Group' : 'الرئيس التنفيذي، مجموعة المنصوري',
                            ...
                            array(
                                ...
                                'role' => $is_en ? 'Director, Elite Properties' : 'مديرة شركة النخبة للعقارات',
                                'text' => $is_en ? 'A masterclass in real estate law. They handled a complex RERA arbitration case for us and won a complete victory.' : 'أفضل ما رأيت في قضايا العقارات في دبي. لقد أداروا قضية تحكيم عقارية معقدة أمام RERA وحققوا لنا نصراً كاملاً.'
                            ),
                            array(
                                'name' => $is_en ? 'Faisal Al-Suwaidi' : 'فيصل السويدي',
        ...
        <div class="container">
            ...
            <div class="blog-grid scroll-reveal-group">
                ...
                if ( $blog_query->have_posts() ) :
                    ...
                    $mock_posts = array(
                        array(
                            'title' => $is_en ? 'Navigating the New UAE Commercial Companies Law' : 'قراءة في قانون الشركات التجارية الجديد بالإمارات',
                            'date'  => $is_en ? 'June 18, 2026' : '18 يونيو 2026',
                            'excerpt' => $is_en ? 'Understand the critical changes in corporate liability and 100% onshore company foreign ownership regulations.' : 'تفصيل للتعديلات الجوهرية الخاصة بنسبة التملك الأجنبي الكامل للشركات التجارية في دبي ومسؤوليات أعضاء مجلس الإدارة.',
                        ...
                        array(
                            ...
                            'excerpt' => $is_en ? 'A structured overview of trademark registrations, copyright filings, and proactive anti-piracy litigation inside Dubai.' : 'دليل تفصيلي حول آليات تسجيل العلامات التجارية وحقوق المؤلف وسبل ملاحقة الاعتداء على الملكية الفكرية محلياً.',
                            'image' => 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80&w=400'
                        ),
                        array(
                            'title' => $is_en ? 'RERA Property Arbitration: A Practical Guide' : 'التحكيم العقاري أمام مركز فض المنازعات الإيجارية بدبي',
                            'date'  => $is_en ? 'May 28, 2026' : '28 مايو 2026',
                            'excerpt' => $is_en ? 'Discover how property arbitration works and key considerations for real estate developers and institutional buyers.' : 'شرح مبسط لآلية تقديم الشكاوى والمطالبات المالية للمستثمرين العقاريين وكيفية صياغة بنود فض النزاعات العقارية.',
                ...
                <div class="contact-methods">
                    <div class="method-card">
                        ...
                        <div class="method-details">
                            ...
                            <a href="tel:+97145551234">+971 4 555 1234</a>
                        </div>
                    </div>
                    <div class="method-card">
                        ...
                        <div class="method-details">
                            ...
                            <a href="mailto:info@dr-ali.ae">info@dr-ali.ae</a>
                        </div>
                    </div>
                    <div class="method-card">
                        <div class="method-icon">📍</div>
                        <div class="method-details">
                            <h4><?php echo $is_en ? 'Dubai Office' : 'مقر المكتب في دبي'; ?></h4>
                            <p><?php echo $is_en ? 'Business Bay, Executive Towers, Tower B, Level 15' : 'الخليج التجاري، أبراج إكزيكتيف، برج B، الطابق 15'; ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form id="dr-ali-contact-form">
                    ...
                    <div class="form-group-row">
                        <div class="form-field-wrapper">
                            ...
                            <input type="tel" id="contact_phone" name="contact_phone" class="form-input" placeholder="<?php echo $is_en ? 'e.g., +971 50 123 4567' : 'مثال: +971 50 123 4567'; ?>" required>
                        </div>
                        <div class="form-field-wrapper">
