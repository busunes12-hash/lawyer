                ...
                if ( $blog_query->have_posts() ) :
                    while ( $blog_query->have_posts() ) : $blog_query->the_post();
                        ...
                        <article class="blog-card reveal reveal-fade-up">
                            <div class="blog-thumbnail-wrapper">
                                ...
                                <?php else : ?>
                                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/blog-fallback.jpg' ); ?>" alt="<?php the_title(); ?>" loading="lazy">
                                <?php endif; ?>
                            </div>
                    ...
                    $mock_posts = array(
                        array(
                            ...
                            'image' => get_template_directory_uri() . '/assets/images/blog-companies.jpg'
                        ),
                        array(
                            ...
                            'image' => get_template_directory_uri() . '/assets/images/blog-ip.jpg'
                        ),
                        array(
                            ...
                            'image' => get_template_directory_uri() . '/assets/images/blog-property.jpg'
                        )
                    );
